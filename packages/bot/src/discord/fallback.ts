...
export async function runFallback(
  ...
  try {
    ...
    // gh issue create uses owner/repo slug, not filesystem path.
    // We derive it from `gh repo view --json nameWithOwner` inside the repo dir.
    ...
    // Trigger opencode via issue comment
